...
1. Fork the [eveSwap Dex Frontend](https://github.com/eveswap/eve-frontend-dex/) repository on GitHub
...
3. Add your **token information** using the example format provided below to `eveswap.json` in the `/src/constants/token/` directory.
